...
dni_df = pd.read_csv(r"csr_africa_dni.csv")
glo_df = pd.read_csv(r'csr_africa_glo.csv')
tilt_df = pd.read_csv(r'csr_africa_tilt.csv')
dif_df = pd.read_csv(r'csr_africa_dif.csv')
