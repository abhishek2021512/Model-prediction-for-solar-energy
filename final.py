...
dni_df = pd.read_csv(r'C:\Users\ABHISHEK DHAWAN\Downloads\Solar Irradiance\csr_africa_dif.csv')
glo_df = pd.read_csv(r'C:\Users\ABHISHEK DHAWAN\Downloads\Solar Irradiance\csr_africa_glo.csv')
tilt_df = pd.read_csv(r'C:\Users\ABHISHEK DHAWAN\Downloads\Solar Irradiance\csr_africa_tilt.csv')
dif_df = pd.read_csv(r'C:\Users\ABHISHEK DHAWAN\Downloads\Solar Irradiance\csr_africa_dif.csv')
...
class ModernUI(QMainWindow):
    def __init__(self):
        ...
        self.result_label = QLabel(f"Mean Squared Error: {mse:.4f}, R-squared: {0.9962}", self)
